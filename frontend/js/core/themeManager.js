...
import { ui } from "../ui/uiCache.js"; // Needed for body class and toggle button
...
export const ThemeManager = {
    ...
    _updateColorsObject() {
        if (!document?.documentElement) {
            console.error("ThemeManager: Cannot update colors, documentElement not found.");
        ...
        Object.assign(colors, {
            ...
            tdeeDiffLineColor: getColor("--tdee-diff-line-color", "tdeeDiffLineColor"),
            annotationMarker: getColor("--annotation-marker-color", "annotationMarker"),
    ...
    init() {
        ...
        console.log(`[ThemeManager Init] Initial theme determined as: ${initialTheme}`);
